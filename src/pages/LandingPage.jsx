  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 animate-fadeIn">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 text-center">
        ...
        {/* OPCIÓN 1: Botones simétricos con efecto hover slide up */}
        <div className="mb-16">
          <p className="text-white font-bold mb-4">Opción 1: Efecto Slide Up</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slideUp delay-200">
            <button
              ...
              className="group bg-white text-purple-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-purple-500/50 transition-all flex items-center gap-2 relative overflow-hidden"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
              <UserPlus className="w-6 h-6 relative z-10 group-hover:text-white transition-colors" />
              <span className="relative z-10 group-hover:text-white transition-colors">Registrarme como profesional</span>
            </button>
            
            <button
              onClick={() => navigate('/client-login')}
              className="group bg-white text-purple-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-green-500/50 transition-all flex items-center gap-2 relative overflow-hidden"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-green-500 to-teal-600 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
              <svg className="w-6 h-6 relative z-10 group-hover:text-white transition-colors" viewBox="0 0 24 24">
                <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                <path fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
                <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/>
              </svg>
              <span className="relative z-10 group-hover:text-white transition-colors">Quiero calificar a alguien</span>
            </button>
          </div>
        </div>

        {/* OPCIÓN 2: Botones con borde gradiente y efecto glow */}
        <div className="mb-16">
          <p className="text-white font-bold mb-4">Opción 2: Efecto Glow</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slideUp delay-200">
            <button
              onClick={() => navigate('/professional-register')}
              className="group relative bg-white text-purple-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:scale-105 transition-all flex items-center gap-2"
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity blur-sm"></div>
              <UserPlus className="w-6 h-6 relative z-10" />
              <span className="relative z-10">Registrarme como profesional</span>
            </button>
            
            <button
              onClick={() => navigate('/client-login')}
              className="group relative bg-white text-green-600 px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:scale-105 transition-all flex items-center gap-2"
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity blur-sm"></div>
              ...
              <span className="relative z-10">Quiero calificar a alguien</span>
            </button>
          </div>
        </div>

        {/* OPCIÓN 3: Botones con gradiente simétricos */}
        <div className="mb-16">
          <p className="text-white font-bold mb-4">Opción 3: Gradientes Simétricos</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slideUp delay-200">
            <button
              onClick={() => navigate('/professional-register')}
              className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-purple-500/50 hover:scale-105 transition-all flex items-center gap-2 hover:brightness-110"
            >
