    ...
    const getTimeRemaining = () => {
        ...
        try {
            ...
            if (typeof rating.createdAt === 'string' && rating.createdAt.includes('T') && !rating.createdAt.includes('Z') && !rating.createdAt.includes('+')) {
                dateString = rating.createdAt + 'Z'; // Forzar interpretación como UTC
            }
            ...
            // Si han pasado más de 30 minutos, tiempo expirado
            if (diffMinutes >= 30) {
                return 'Tiempo expirado';
            }

            // Si el tiempo es negativo (fecha en el futuro), return 'Tiempo expirado'
            if (diffMinutes < 0) {
                return 'Tiempo expirado';
            }
