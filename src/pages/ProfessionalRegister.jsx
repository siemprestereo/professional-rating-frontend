        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="flex items-start gap-3 cursor-pointer mb-5 group">
            <div className="relative mt-0.5 flex-shrink-0">
              ...
              <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all ${termsAccepted ? 'bg-blue-500 border-blue-500' : 'border-gray-300 bg-white group-hover:border-gray-400'
                }`}>
                {termsAccepted && (
