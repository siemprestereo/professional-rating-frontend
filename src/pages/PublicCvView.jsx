...
function PublicCvView() {
  ...
  // ✅ Carga paralela: CV (siempre público) + Favoritos (solo clientes)
    ...
    try {
      ...
      if (isClient) {
        ...
        try {
          ...
          console.log('No se pudieron cargar favoritos (es normal si no eres cliente)');
        } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      {/* ✅ Si no está logueado, aplicar blur */}
      <div className={!isLoggedIn ? 'filter blur-sm pointer-events-none' : ''}>
        ...
        {/* Resto del contenido (contacto, descripción, trabajos, educación) */}
        <div className="max-w-4xl mx-auto px-4 -mt-20 pb-8">
          ...
          {/* Secciones de trabajo y educación... (igual que antes) */}
          {/* Copiá todo el resto del código que tenías */}
      ...
      {!isLoggedIn && (
        <LoginRequiredModal onClose={() => navigate('/')} />
      )}
