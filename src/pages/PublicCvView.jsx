...
import { GraduationCap, ChevronRight, Home, Heart, Share2, MapPin } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="fixed bottom-4 left-0 right-0 flex justify-center z-50">
        <button onClick={() => navigate(-1)} className="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-2xl border-4 border-white" aria-label="Volver atrás">
