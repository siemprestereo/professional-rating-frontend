    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 z-50 sm:absolute sm:bottom-auto sm:left-auto sm:right-0 sm:mt-2 sm:w-80">
          <div className="w-full sm:w-80 bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden animate-slideUp">
