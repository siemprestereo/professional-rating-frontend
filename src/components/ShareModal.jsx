    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn p-4">
      ...
      <div className="bg-white rounded-3xl max-w-md w-full max-h-[90vh] overflow-y-auto animate-scaleIn">
        ...
        <div className="p-4 sm:p-6">
          ...
          {/* ✅ COMPACTAR BOTONES DE COMPARTIR */}
          <div className="pt-3 sm:pt-4 border-t border-gray-200">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <a 
                ...
                className="flex flex-col items-center justify-center p-2 sm:p-3 border-2 border-gray-200 rounded-xl hover:bg-green-50 hover:border-green-500 transition-all"
              >
                ...
                <span className="text-[10px] sm:text-xs mt-1 text-gray-600">WhatsApp</span>
              </a>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex flex-col items-center justify-center p-2 sm:p-3 border-2 border-gray-200 rounded-xl hover:bg-blue-50 hover:border-blue-500 transition-all"
              >
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-blue-700" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
                <span className="text-[10px] sm:text-xs mt-1 text-gray-600">LinkedIn</span>
              </a>

              <a 
                href={`mailto:?subject=${encodeURIComponent('Mi CV Profesional')}&body=${encodeURIComponent(`Te comparto mi CV: ${publicUrl}`)}`} 
                className="flex flex-col items-center justify-center p-2 sm:p-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all"
              >
                ...
                <span className="text-[10px] sm:text-xs mt-1 text-gray-600">Email</span>
              </a>
            </div>
          </div>
        </div>
